...
function ViewSingleUser({route}) {
  ...
  return (
    ...
    <Block flex style={styles.profile}>
       {
          filterSpecificUser.length > 0 ?  filterSpecificUser?.slice(0, 1)?.map((user) => (
      <ImageBackground
                ...
                <Block flex style={styles.profileCard}>
                  ...
                  <Block flex>
                    <Block middle style={styles.nameInfo}>
                      <Text  size={28} color="#32325D" style={{color : argonTheme.COLORS.PRIMARY}}>
